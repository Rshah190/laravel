...
<head>
  ...
  <link href="{{asset('assets/backend/dist/css/image_uploader.min.css')}}" rel="stylesheet">
  <link href="{{asset('assets/backend/plugins/ekko-lightbox/ekko-lightbox.css')}}" rel="stylesheet">

  <link href="https://cdn.jsdelivr.net/npm/semantic-ui@2.2.13/dist/semantic.min.css" rel="stylesheet">

<style>
  table#example1 tr td i {
  padding-right: 10px;
  font-size: 12px;
}
</style>
...
<script src="{{asset('assets/backend/validations/form_validation.js')}}"></script>
<script src="{{asset('assets/backend/dist/js/image_uploader.min.js')}}"></script>
